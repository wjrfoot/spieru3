...
//        URL imageURL = getClass().getClassLoader().getResource("background.png");
        ...
        this.setTitle("Durham Wheat Analyzer");
    ...
    private void initComponents() {
        ...
        jBScanAnalyze.setEnabled(false);
...
//        String lastInputDirectory = config.getLastInputDirectory();
        JFileChooser file = new JFileChooser();
        file.setMultiSelectionEnabled(false);
        file.setFileSelectionMode(JFileChooser.FILES_AND_DIRECTORIES);
        file.setFileHidingEnabled(false);
        File dirF = new File(System.getProperty("user.dir"), "images");
        file.setCurrentDirectory(dirF);
//        file.setCurrentDirectory(new File(lastInputDirectory));
...
//            fils = file.getSelectedFiles();
            System.out.println("selected file: " + file.getSelectedFile().getAbsolutePath());
        }
...
//        jBAnalyze.setEnabled(true);
        ...
        AnalyzeScan analyze = new AnalyzeScan(file.getSelectedFile().getAbsolutePath(), config);
        analyze.analyze();
