...
/**
 * This plugin computes watershed on the inverse of the distance map of a binary
 * image. Imposition of extended minima is used to control the number of local
 * minima. This way, touching objects can be interactively separated.
 *
 * @author Ignacio Arganda-Carreras (ignacio.arganda@ehu.eus)
 *
 */
public class DistanceTransformWatershedMod implements PlugInFilter, ExtendedPlugInFilter,
        DialogListener {
...
//		if (previewing)
    ...
    public void setChamberMaks(ChamferMask2D chamferMask2D) {
        this.chamferMask = chamferMask2D;
    }
